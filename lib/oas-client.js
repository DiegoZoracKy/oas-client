...
function createApiClient(apiSpec, { baseServerUrl, defaultParameters, apiSpecFormat = '', axiosConfig = {}, serverUrls = {}, paths = {}, allowUnexpectedParams = true, validateParameters = true, validateBody = false, serverUrlIndex = 0 } = {}) {
